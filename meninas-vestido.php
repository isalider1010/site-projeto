...
$produtos = [
  [
    "imagem" => "vestido (a).jpeg",
    "nome" => "Vestido Floral Azul",
    "preco" => "R$ 189,90"
  ],
  [
    "imagem" => "vestido(a)2.jpeg",
    "nome" => "Vestido Rosa com Laço",
    "preco" => "R$ 189,90"
  ]
];
?>
      ...
      <div class="container">
        ...
        <div class="row g-4">
          <?php foreach ($produtos as $produto): 
            $linkWhatsapp = "https://wa.me/5544998443838?text=" . urlencode("Olá! Tenho interesse no produto: {$produto['nome']} - {$produto['preco']}");
          ?>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="card h-100 d-flex flex-column">
                ...
                <div class="card-body d-flex flex-column">
                  ...
                  <a href="<?= $linkWhatsapp ?>" target="_blank" class="btn btn-success w-100 mt-auto">
      ...
      <div class="container py-5">
        <div class="row justify-content-between text-center text-md-start">
          <div class="col-md-4 mb-4">
            ...
            <p class="mb-1">
              <a href="https://www.google.com/maps?q=Av.+Capitão+Índio+Bandera,+1400,+Paraná+-+PR" target="_blank" class="text-white text-decoration-none">Av. Capitão Índio Bandera, 1400</a>
            </p>
