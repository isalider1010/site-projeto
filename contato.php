...
<body>
  ...
  <div class="container py-5">
    <h2 class="mb-4 text-center fw-bold">Entre em Contato</h2>
    <form id="form-contato" method="POST" action="enviar.php" novalidate>
      <div class="row mb-3">
        <div class="col-md-4">
  ...
  <div id="social-icons" class="text-center my-4">
    <a href="https://www.facebook.com/boleira.lia" target="_blank" aria-label="Facebook" class="me-3 fs-3 text-primary">
      <i class="fab fa-facebook"></i>
    </a>
    <a href="https://www.instagram.com/lbc12020" target="_blank" aria-label="Instagram" class="me-3 fs-3 text-danger">
      <i class="fab fa-instagram"></i>
    </a>
    <a href="https://wa.me/5544988563181" target="_blank" aria-label="WhatsApp" class="fs-3 text-success">
